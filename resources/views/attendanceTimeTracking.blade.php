        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                <div class="bg-white rounded-lg shadow px-3 py-2 text-center">
                    <p class="text-sm mb-1 text-gray-600">Current Time</p>
                    <p class="text-xl mb-1 font-bold text-blue-600" x-text="currentTime.toLocaleTimeString()"></p>
                    <p class="text-xs mb-1 text-gray-500" x-text="currentTime.toLocaleDateString('en-US', {weekday: 'long', year: 'numeric', month: 'long', day: 'numeric'})"></p>
                </div>
            </div>
        </div>
    </div>
