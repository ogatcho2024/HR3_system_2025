...
@section('title', 'My Reimbursements')
    ...
    <div class="bg-white shadow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">My Reimbursements</h1>
                    <p class="text-gray-600">Submit and track your expense reimbursement requests</p>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $reimbursements->where('status', 'pending')->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $reimbursements->where('status', 'approved')->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ $reimbursements->where('status', 'rejected')->count() }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">${{ number_format($reimbursements->where('status', 'approved')->sum('amount'), 2) }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Reimbursement Requests</h3>
                <p class="text-sm text-gray-500 mt-1">Your submitted expense reimbursement requests</p>
            </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-8 w-8">
                                        ...
                                        @elseif($reimbursement->type == 'Meal')
                                    ...
                                    <div class="ml-3">
                                        <div class="text-sm font-medium text-gray-900">{{ $reimbursement->type }}</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900">{{ Str::limit($reimbursement->description, 50) }}</div>
                            </td>
            ...
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">You haven't submitted any reimbursement requests yet.</p>
                <div class="mt-6">
